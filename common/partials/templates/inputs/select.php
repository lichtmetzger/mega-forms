...
/**
 * The Template for displaying input type: select
 *
 * This template can be overridden by copying it to yourtheme/mega-forms/input/select.php.
 *
...
echo get_mf_select($attributes, $options);
