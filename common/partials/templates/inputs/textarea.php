...
/**
 * The Template for displaying input type: textarea
 *
 * This template can be overridden by copying it to yourtheme/mega-forms/input/textarea.php.
 *
...
echo get_mf_textarea($attributes);
