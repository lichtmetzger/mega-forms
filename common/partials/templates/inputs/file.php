...
/**
 * The Template for displaying input type: file
 *
 * This template can be overridden by copying it to yourtheme/mega-forms/input/file.php.
 *
...
echo get_mf_input('file', $attributes);
