...
/**
 * The Template for displaying input type: text
 *
 * This template can be overridden by copying it to yourtheme/mega-forms/input/text.php.
 *
...
echo get_mf_input($inputType, $attributes);
